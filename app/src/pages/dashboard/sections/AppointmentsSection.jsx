              ...
              return (
                <div key={apt.id} className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-line-light bg-surface p-5 shadow-md">
                  <div className="flex items-center gap-4">
                    <div className="flex h-14 w-14 shrink-0 flex-col items-center justify-center rounded-2xl bg-[linear-gradient(135deg,var(--primary-color),var(--primary-dark))] text-on-primary">
                ...
                {openSlots.map((slot) => (
                  <button
                    ...
                    className={`rounded-full border px-4 py-2 text-xs font-bold transition-colors ${
                      timeSlot === slot ? 'border-primary bg-primary text-on-primary' : 'border-line-light bg-canvas text-ink-2 hover:border-primary'
                    }`}
                  >
                    {slot}
                  </button>
