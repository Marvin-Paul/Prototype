...
export const MOODS = {
  happy: { emoji: '😊', color: '#10b981', description: 'Happy', groupName: 'Happy Group', icon: 'fa-smile' },
  anxious: { emoji: '😰', color: '#f59e0b', description: 'Anxious', groupName: 'Anxious Group', icon: 'fa-heartbeat' },
  stressed: { emoji: '😤', color: '#ef4444', description: 'Stressed', groupName: 'Stressed Group', icon: 'fa-exclamation-triangle' },
  excited: { emoji: '🤩', color: '#8b5cf6', description: 'Excited', groupName: 'Excited Group', icon: 'fa-star' },
  sad: { emoji: '😢', color: '#3b82f6', description: 'Sad', groupName: 'Sad Group', icon: 'fa-frown' },
  motivated: { emoji: '💪', color: '#06b6d4', description: 'Motivated', groupName: 'Motivated Group', icon: 'fa-fire' },
  overwhelmed: { emoji: '😵', color: '#dc2626', description: 'Overwhelmed', groupName: 'Overwhelmed Group', icon: 'fa-exclamation-circle' },
  lonely: { emoji: '😔', color: '#6b7280', description: 'Lonely', groupName: 'Lonely Group', icon: 'fa-user' },
}
